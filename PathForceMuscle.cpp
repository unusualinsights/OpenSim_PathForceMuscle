...
const int PathForceMuscle::STATE_ACTIVATION = 0;
const int PathForceMuscle::STATE_FIBER_LENGTH = 1;
 ...
 * Default constructor.
 */
PathForceMuscle::PathForceMuscle() :
   AbstractMuscle(),
 ...
 * Copy constructor.
 *
 * @param aMuscle PathForceMuscle to be copied.
 */
PathForceMuscle::PathForceMuscle(const PathForceMuscle &aMuscle) :
 ...
 *
 * @return Pointer to a copy of this PathForceMuscle.
 */
Object* PathForceMuscle::copy() const
{
	PathForceMuscle *musc = new PathForceMuscle(*this);
	return(musc);
}
...
//_____________________________________________________________________________
/**
 * Copy data members from one PathForceMuscle to another.
 *
 * @param aMuscle PathForceMuscle to be copied.
 */
void PathForceMuscle::copyData(const PathForceMuscle &aMuscle)
{
...
//_____________________________________________________________________________
/**
 * Set the data members of this PathForceMuscle to their null values.
 */
void PathForceMuscle::setNull()
{
	setType("PathForceMuscle");
 ...
 */
void PathForceMuscle::setupProperties()
{
 ...
 *
 * @param aModel model containing this PathForceMuscle.
 */
void PathForceMuscle::setup(Model* aModel)
{
	// Base class
 ...
 */
void PathForceMuscle::copyPropertyValues(AbstractActuator& aActuator)
{
 ...
 */
PathForceMuscle& PathForceMuscle::operator=(const PathForceMuscle &aMuscle)
{
	// BASE CLASS
 ...
 */
void PathForceMuscle::scale(const ScaleSet& aScaleSet)
{
 ...
 * @param aScaleSet XYZ scale factors for the bodies.
 */
void PathForceMuscle::postScale(const ScaleSet& aScaleSet)
{
	// Base class
 ...
 */
double PathForceMuscle::getPennationAngle()
{
 ...
 */
double PathForceMuscle::getFiberLength()
{
	return _fiberLength;
}
//_____________________________________________________________________________
 ...
 * @param Current length of the muscle fiber(s).
 */
double PathForceMuscle::getNormalizedFiberLength()
{
 ...
 */
double PathForceMuscle::getPassiveFiberForce()
{
 ...
 */
void PathForceMuscle::computeStateDerivatives(double rDYDT[])
{
	if (!rDYDT)
		return;
 ...
 */
void PathForceMuscle::computeEquilibrium()
{
 ...
 */
void PathForceMuscle::computeActuation()
{
 ...
 */
double PathForceMuscle::calcTendonForce(double aNormTendonLength) const
{
 ...
 */
double PathForceMuscle::calcPassiveForce(double aNormFiberLength) const
{
 ...
 */
double PathForceMuscle::calcActiveForce(double aNormFiberLength) const
{
 ...
 */
double PathForceMuscle::calcFiberVelocity(double aActivation, double aActiveForce, double aVelocityDependentForce) const
{
 ...
 */
double PathForceMuscle::getStress() const
{
